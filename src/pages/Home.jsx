...
const Home = () => {
  ...
  // Remove Unsplash API fetching logic and use static images
  // TODO: Replace these URLs with your own downloaded images
  const heroImages = [
    '/images/your-image1.jpg',
    '/images/your-image2.jpg',
    '/images/your-image3.jpg',
    '/images/your-image4.jpg',
    '/images/your-image5.jpg',
  ];
  ...
  const popularPackages = [
    { title: 'Maldives Getaway', price: '$799', img: 'https://source.unsplash.com/random/400x250?maldives', desc: '5 nights in a luxury resort with all meals.' },
    { title: 'Swiss Alps Adventure', price: '$999', img: 'https://source.unsplash.com/random/400x250?switzerland', desc: '7 days of hiking, skiing, and sightseeing.' },
    { title: 'Dubai City Break', price: '$599', img: 'https://source.unsplash.com/random/400x250?dubai', desc: '4 nights, desert safari, and city tours.' },
  ];
  ...
  return (
    <Box>
      ...
      >
        <Container>
          ...
          >
            ...
            {/* Travel Images Row */}
            <Box sx={{ display: 'flex', justifyContent: 'center', gap: { xs: 1, md: 3 }, mb: 4, flexWrap: 'wrap' }}>
              {heroImages.map((img, idx) => (
                <img
                  key={idx}
                  src={img}
                  alt="World Tourist Place"
                  style={{
                    borderRadius: 10,
              ...
              >
                ...
                >
                  ...
                  <CardContent sx={{ flexGrow: 1, p: { xs: 2, md: 4 }, backgroundColor: 'var(--surface-color)' }}>
                    ...
                    <Typography sx={{ color: 'var(--text-light)', fontSize: { xs: '1rem', md: '1.08rem' } }}>
      ...
      <motion.div initial={{ opacity: 0, y: 60 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.4 }}>
        <Container sx={{ py: { xs: 4, md: 8 }, textAlign: 'center' }}>
          <div style={{ margin: '0 auto', maxWidth: 600 }}>
            <Typography variant="h4" sx={{ color: 'var(--primary-color)', fontWeight: 700, mb: 2 }}>
              Ready to plan your next adventure?
            </Typography>
            <Typography sx={{ color: 'var(--text-light)', mb: 3 }}>
              Explore our packages or contact us for a custom trip. Your dream vacation is just a click away!
            </Typography>
            <button style={{ background: 'var(--accent-color)', color: '#fff', border: 'none', borderRadius: 8, padding: '16px 40px', fontWeight: 700, fontSize: 20, cursor: 'pointer', transition: 'var(--transition)' }}>
              Plan Your Trip
            </button>
          </div>
        </Container>
